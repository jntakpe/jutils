-- Fichier chargé au d?marrage du serveur si JPA est configuré en mode create,create-drop ou update

-- Table de paramétrage
INSERT INTO public.parameter (id, version, key, value) VALUES (nextval('seq_parameter'), 0, 'smtp.host', 'ptx.smtp.corp.sopra');
INSERT INTO public.parameter (id, version, key, value) VALUES (nextval('seq_parameter'), 0, 'smtp.port', '25');
INSERT INTO public.parameter (id, version, key, value) VALUES (nextval('seq_parameter'), 0, 'smtp.from', 'jutils@sopragroup.com');
INSERT INTO public.parameter (id, version, key, value) VALUES (nextval('seq_parameter'), 0, 'sopra.mail.frame', '<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=iso-8859-1">
...
.MsoChpDefault
	...
	font-size:10.0pt;}
@page WordSection1
	{size:612.0pt 792.0pt;margin:70.85pt 70.85pt 70.85pt 70.85pt;}div.WordSection1 {page:WordSection1;}--></style><!--[if gte mso 9]><xml><o:shapedefaults v:ext="edit" spidmax="1026" /></xml><![endif]--><!--[if gte mso 9]><xml><o:shapelayout v:ext="edit"><o:idmap v:ext="edit" data="1" /></o:shapelayout></xml><![endif]--></head><body lang=FR link=blue vlink=purple><div class=WordSection1><p class=MsoNormal><span style=''color:#1F497D''>${mailText}<o:p></o:p></span></p><p class=MsoNormal><span style=''color:#1F497D''><o:p>&nbsp;</o:p></span></p><div><table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0><tr><td valign=top style=''padding:0cm 0cm 0cm 0cm''><div><p class=MsoNormal><span style=''font-size:10.0pt;font-family:"Arial","sans-serif";color:black''>Cordialement,<o:p></o:p></span></p></div></td></tr><tr><td valign=top style=''padding:0cm 4.5pt 0cm 0cm''><div><p class=MsoNormal><b><span style=''font-size:8.0pt;font-family:"Arial","sans-serif";color:black''><br>${nom}<o:p></o:p></span></b></p><p class=MsoNormal><span style=''font-size:8.0pt;font-family:"Arial","sans-serif";color:black''>Banque &amp; Finance<b><o:p></o:p></b></span></p></div></td></tr><tr><td style=''padding:0cm 0cm 0cm 0cm''><p class=MsoNormal><b><span style=''color:#DA162E''>Sopra</span></b><b><i><span style=''font-size:7.5pt;font-family:"Helvetica","sans-serif";color:#1F497D''> group</span></i></b><b><span style=''font-size:14.0pt;font-family:"Helvetica","sans-serif";color:red''>.</span></b><b><span style=''font-size:12.0pt;color:#1F497D''><o:p></o:p></span></b></p></td></tr><tr><td style=''border-top:none;border-left:none;border-bottom:solid #C80A2D 1.0pt;border-right:solid #C80A2D 1.0pt;padding:4.5pt 4.5pt 4.5pt 0cm''><div><p class=MsoNormal><span style=''font-size:8.0pt;font-family:"Arial","sans-serif";color:#888888''>1 Avenue André Marie Ampère<br>CS 10134 - 31772 Colomiers Cedex<br>Phone : +33 (0)5 34 56 ${tel}<br><a href="mailto:jguerrin@sopragroup.com"><span style=''color:#888888;text-decoration:none''>${email}</span></a> - <a href="http://www.sopragroup.com"><span style=''color:#888888;text-decoration:none''>www.sopragroup.com</span></a><o:p></o:p></span></p></div></td></tr></table><p class=MsoNormal><span style=''color:#1F497D;display:none''><o:p>&nbsp;</o:p></span></p><table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0><tr><td style=''padding:12.0pt 4.5pt 4.5pt 0cm''><p class=MsoNormal><span style=''font-size:8.0pt;font-family:"Arial","sans-serif";color:#888888''>Ce message peut contenir des informations confidentielles dont la divulgation est à ce titre rigoureusement interdite en l''absence d''autorisation explicite de l''émetteur. Dans l''hypothèse où vous auriez reçu par erreur ce message, merci de le renvoyer à l&#8217;émetteur et de détruire toute copie.<br><br></span><span style=''font-size:18.0pt;font-family:Webdings;color:#888888''>P</span><span style=''font-size:8.0pt;font-family:"Arial","sans-serif";color:#888888''>&nbsp;Pensez à l&#8217;environnement avant d&#8217;imprimer.<o:p></o:p></span></p></td></tr></table><p class=MsoNormal><span style=''color:#1F497D''><o:p>&nbsp;</o:p></span></p><p class=MsoNormal><span style=''color:#1F497D''><o:p>&nbsp;</o:p></span></p><div><div style=''border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0cm 0cm 0cm''><p class=MsoNormal><b><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif"''>De&nbsp;:</span></b><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif"''> Delagnes Sylvain <br><b>Envoyé&nbsp;:</b> mercredi 3 juillet 2013 11:53<br><b>À&nbsp;:</b> Dupuy Pierre; Clerc Tom; Courtiol Alexandre; Guerrin Julien; N''takpe Jocelyn; Cesar Bertrand; Marion Nicolas; Moisson Florent<br><b>Objet&nbsp;:</b> RE: Ste Gé !<o:p></o:p></span></p></div></div><p class=MsoNormal><o:p>&nbsp;</o:p></p><p class=MsoNormal><span style=''color:#1F497D''>oui<o:p></o:p></span></p><p class=MsoNormal><span style=''color:#1F497D''><o:p>&nbsp;</o:p></span></p><div><div style=''border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0cm 0cm 0cm''><p class=MsoNormal><b><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif"''>De&nbsp;:</span></b><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif"''> Dupuy Pierre <br><b>Envoyé&nbsp;:</b> mercredi 3 juillet 2013 11:53<br><b>À&nbsp;:</b> Delagnes Sylvain; Clerc Tom; Courtiol Alexandre; Guerrin Julien; N''takpe Jocelyn; Cesar Bertrand; Marion Nicolas; Moisson Florent<br><b>Objet&nbsp;:</b> RE: Ste Gé !<o:p></o:p></span></p></div></div><p class=MsoNormal><o:p>&nbsp;</o:p></p><p class=MsoNormal><span style=''color:#1F497D''>T&#8217;as faim&nbsp;?<o:p></o:p></span></p><p class=MsoNormal><span style=''color:#1F497D''><o:p>&nbsp;</o:p></span></p><div><div style=''border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0cm 0cm 0cm''><p class=MsoNormal><b><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif"''>De&nbsp;:</span></b><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif"''> Delagnes Sylvain <br><b>Envoyé&nbsp;:</b> mercredi 3 juillet 2013 11:53<br><b>À&nbsp;:</b> Clerc Tom; Courtiol Alexandre; Guerrin Julien; N''takpe Jocelyn; Dupuy Pierre; Cesar Bertrand; Marion Nicolas; Moisson Florent<br><b>Objet&nbsp;:</b> RE: Ste Gé !<o:p></o:p></span></p></div></div><p class=MsoNormal><o:p>&nbsp;</o:p></p><p class=MsoNormal><span style=''color:#1F497D''>GO&nbsp;?<o:p></o:p></span></p><p class=MsoNormal><span style=''color:#1F497D''><o:p>&nbsp;</o:p></span></p><div><div style=''border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0cm 0cm 0cm''><p class=MsoNormal><b><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif"''>De&nbsp;:</span></b><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif"''> Clerc Tom <br><b>Envoyé&nbsp;:</b> mercredi 3 juillet 2013 11:23<br><b>À&nbsp;:</b> Courtiol Alexandre; Delagnes Sylvain; Guerrin Julien; N''takpe Jocelyn; Dupuy Pierre; Cesar Bertrand; Marion Nicolas; Moisson Florent<br><b>Objet&nbsp;:</b> RE: Ste Gé !<o:p></o:p></span></p></div></div><p class=MsoNormal><o:p>&nbsp;</o:p></p><p class=MsoNormal><span style=''color:#1F497D''>C&#8217;est bon c&#8217;est réservé, ce qui ne sont pas là au début auront pas la bière d&#8217;offerte&#8230; <o:p></o:p></span></p><p class=MsoNormal><span style=''color:#1F497D''><o:p>&nbsp;</o:p></span></p><div><div style=''border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0cm 0cm 0cm''><p class=MsoNormal><b><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif"''>De&nbsp;:</span></b><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif"''> Courtiol Alexandre <br><b>Envoyé&nbsp;:</b> mercredi 3 juillet 2013 11:02<br><b>À&nbsp;:</b> Delagnes Sylvain; Guerrin Julien; N''takpe Jocelyn; Clerc Tom; Dupuy Pierre; Cesar Bertrand; Marion Nicolas; Moisson Florent<br><b>Objet&nbsp;:</b> RE: Ste Gé !<o:p></o:p></span></p></div></div><p class=MsoNormal><o:p>&nbsp;</o:p></p><p class=MsoNormal><a href="https://fr-fr.facebook.com/pages/Le-Sainte-Germaine/397878076925600">https://fr-fr.facebook.com/pages/Le-Sainte-Germaine/397878076925600</a><o:p></o:p></p><p class=MsoNormal><o:p>&nbsp;</o:p></p><p class=MsoNormal>Pour toi Tom&nbsp;!<span style=''color:#1F497D''><o:p></o:p></span></p><p class=MsoNormal><span style=''color:#1F497D''><o:p>&nbsp;</o:p></span></p><div><div style=''border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0cm 0cm 0cm''><p class=MsoNormal><b><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif"''>De&nbsp;:</span></b><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif"''> Delagnes Sylvain <br><b>Envoyé&nbsp;:</b> mercredi 3 juillet 2013 11:00<br><b>À&nbsp;:</b> Courtiol Alexandre; Guerrin Julien; N''takpe Jocelyn; Clerc Tom; Dupuy Pierre; Cesar Bertrand; Marion Nicolas; Moisson Florent<br><b>Objet&nbsp;:</b> RE: Ste Gé !<o:p></o:p></span></p></div></div><p class=MsoNormal><o:p>&nbsp;</o:p></p><p class=MsoNormal><span style=''color:#1F497D''>non<o:p></o:p></span></p><p class=MsoNormal><span style=''color:#1F497D''><o:p>&nbsp;</o:p></span></p><div><div style=''border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0cm 0cm 0cm''><p class=MsoNormal><b><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif"''>De&nbsp;:</span></b><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif"''> Courtiol Alexandre <br><b>Envoyé&nbsp;:</b> mercredi 3 juillet 2013 10:59<br><b>À&nbsp;:</b> Guerrin Julien; N''takpe Jocelyn; Clerc Tom; Dupuy Pierre; Delagnes Sylvain; Cesar Bertrand; Marion Nicolas; Moisson Florent<br><b>Objet&nbsp;:</b> Ste Gé !<o:p></o:p></span></p></div></div><p class=MsoNormal><o:p>&nbsp;</o:p></p><p class=MsoNormal><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif";color:#333333;background:white''>Plat du jour : Hachis parmentier ou Brochettes de coeurs de canard&nbsp;!<o:p></o:p></span></p><p class=MsoNormal><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif";color:#333333;background:white''><o:p>&nbsp;</o:p></span></p><p class=MsoNormal><span style=''font-size:10.0pt;font-family:"Tahoma","sans-serif";color:#333333;background:white''>Quelqu&#8217;un a pensé à réserver&nbsp;?</span><o:p></o:p></p></div></div></body></html>');
